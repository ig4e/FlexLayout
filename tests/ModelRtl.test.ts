...
describe("Tree RTL", function () {
    ...
    describe("Actions", () => {
        ...
        describe("Add", () => {
            ...
            describe("tabsets", () => {
                beforeEach(() => {
                    const layout = JSON.parse(JSON.stringify(twoTabs));
                    layout.global.enableRtl = true;
            ...
            describe("borders", () => {
                beforeEach(() => {
                    const layout = JSON.parse(JSON.stringify(withBorders));
                    layout.global.enableRtl = true;
                    model = Model.fromJson(layout);
                    textRender(model);
        ...
        describe("Move", () => {
            beforeEach(() => {
                const layout = JSON.parse(JSON.stringify(threeTabs));
                layout.global.enableRtl = true;
                model = Model.fromJson(layout);
                textRender(model);
